    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="#content">Definition of Conditional Statement</a></li>
            <li><a class="dropdown-item" href="#if">If Type</a></li>
            <li><a class="dropdown-item" href="#ifelse">If Else Type</a></li>
            <li><a class="dropdown-item" href="#ifelseif">If Elseif Type</a></li>
            <li><a class="dropdown-item" href="#switch">Switch Type</a></li>
          </ul>
        </li>
      </ul>
      <form class="d-flex">
