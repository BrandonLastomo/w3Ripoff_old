    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="#content">Definition of Data Type</a></li>
            <li><a class="dropdown-item" href="#int">Integer Data Type</a></li>
            <li><a class="dropdown-item" href="#float">Float Data Type</a></li>
            <li><a class="dropdown-item" href="#string">String Data Type</a></li>
            <li><a class="dropdown-item" href="#char">Char Data Type</a></li>
          </ul>
        </li>
      </ul>
      <form class="d-flex">
