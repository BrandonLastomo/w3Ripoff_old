    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="#content">Definition of Array</a></li>
            <li><a class="dropdown-item" href="#ind">Indexed Array</a></li>
            <li><a class="dropdown-item" href="#asso">Associative Array</a></li>
            <li><a class="dropdown-item" href="#mul">Multidimensional Array</a></li>
          </ul>
        </li>
      </ul>
      <form class="d-flex">
